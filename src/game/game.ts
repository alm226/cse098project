...
class Config implements JetLagGameConfig {
  ...
  musicNames = ["Ghosted The Game theme.wav"];
  soundNames = [];
  imageNames = ["tile_1.png", "tile_2.png", "key.png", "pause.png", "restart.png", "endLevel.png",
    ...
    "wall_tile.png", "astral_sprite_npc.png", "level_1_button.png",
    "level_2_button.png", "level_3_button.png", "level_4_button.png", "level_5_button.png", "play_button.png",
    "Delete_data_button.png", "Credits_button.png", "level_select_button.png", "title_card.png", "colored_blank_title.png"];
}
